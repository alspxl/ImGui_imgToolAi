...
void Application::DrawToolPanel() {
    ...
    if (ImGui::CollapsingHeader("\xe8\x89\xb2\xe5\xbd\xa9\xe8\xb0\x83\xe6\x95\xb4 (Color Adjustments)")) {
        ...
        ImGui::Text("HSL");
        ImGui::SetNextItemWidth(-1);
        ImGui::SliderFloat("##hue", &hue_shift_, -180.f, 180.f, "\xe8\x89\xb2\xe7\x9b\xb8 (Hue) %.1f");
        ImGui::SetNextItemWidth(-1);
        ImGui::SliderFloat("##sat", &sat_scale_, -1.f, 1.f, "\xe9\xa5\xb1\xe5\x92\x8c\xe5\xba\xa6 (Sat) %.2f");
        ImGui::SetNextItemWidth(-1);
        ImGui::SliderFloat("##light", &light_shift_, -0.5f, 0.5f, "\xe4\xba\xae\xe5\xba\xa6 (Light) %.2f");
