...
bool HistoryManager::Undo(int& out_width, int& out_height, int& out_channels, unsigned char*& out_data) {
...
bool HistoryManager::Redo(int& out_width, int& out_height, int& out_channels, unsigned char*& out_data) {
